...
public class ShibaInu_PageListWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(ShibaInu.PageList), typeof(ShibaInu.ViewPager));
	...
	static int SyncPropertys(IntPtr L)
	{
		try
		{
			...
			ShibaInu.PageList obj = (ShibaInu.PageList)ToLua.CheckObject<ShibaInu.PageList>(L, 1);
	...
	static int get_itemPrefab(IntPtr L)
	{
		...
		try
		{
			...
			ShibaInu.PageList obj = (ShibaInu.PageList)o;
