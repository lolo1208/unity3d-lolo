...
public static class CustomSettings
{
	...
	public static BindType[] customTypeList = {                
		...
		_GT (typeof(SpriteRenderer)).AddExtendType (typeof(DG.Tweening.ShortcutExtensions46)),
		// 加新组件，记得在 #else 添加对应的代码
		...
		_GT (typeof(DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)).SetWrapName ("DG_Tweening_Plugins_Options_String").SetLibName ("DG_Tweening_Plugins_Options_String"),
