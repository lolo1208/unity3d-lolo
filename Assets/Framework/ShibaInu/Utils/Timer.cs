...
namespace ShibaInu
{
	...
	public class Timer
	{
		...
		/// 正在运行中的定时器列表
		private static HashSet<Timer> s_runningTimers = new HashSet<Timer> ();
		/// 运行状态有变化的定时器列表
		private static HashSet<Timer> s_changedTimers = new HashSet<Timer> ();
		...
		public static Timer Create (int delay, int repeatCount, Action<Timer> callback, System.Object data = null)
		{
		...
		/// <param name="callback">Callback.</param>
		/// <param name="data">Data.</param>
		public static Timer Once (int delay, Action<Timer> callback, System.Object data = null)
		{
