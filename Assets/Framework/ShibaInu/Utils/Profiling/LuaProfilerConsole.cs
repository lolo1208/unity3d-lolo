...
namespace ShibaInu
{
	...
	public class LuaProfilerConsole : MonoBehaviour
	{
		...
		private Rect m_p3 = new Rect (370, 47, 0, 0);
		private Rect m_p4 = new Rect (450, 40, 130, 50);
		private Rect m_p5 = new Rect (630, 40, 110, 50);
		private Rect m_p6 = new Rect (790, 35, 150, 60);
		private Rect m_p7 = new Rect (1010, 40, 50, 50);
